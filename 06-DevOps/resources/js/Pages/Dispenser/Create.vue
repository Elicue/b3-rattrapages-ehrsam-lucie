          ...
          <form @submit.prevent="create">
            <div>
              <div class="flex flex-col gap-4 mt-4">
                <!-- <label>name</label> -->
                <input class="border-2 border-[#a5a5a6] rounded placeholder-[#1d1d21]" v-model="form.name" type="text" placeholder="Dispenser name"/>
              ...
              <div  class="flex flex-col gap-4 mt-4">
                ...
                <input class="border-2 border-[#a5a5a6] rounded placeholder-[#1d1d21]" v-model="form.location" type="text" placeholder="Dispenser location"/>
              </div>
              <div  class="flex flex-col gap-4 mt-4">
                <!-- <label for="status-select">status : {{ selected }}</label> -->
                <select class="border-2 border-[#a5a5a6] rounded placeholder-[#1d1d21]" name="status" v-model="form.status" id="status-select">
              ...
              <div class="flex flex-col gap-4 mt-4 ">
                <button class="bg-[#0311a5] text-white font-semibold rounded py-2 text-lg" type="submit">Create</button>
              </div>
            </div>
          </form>
        </div>
